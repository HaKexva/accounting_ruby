...
class DashboardControllerTest < ActionDispatch::IntegrationTest
  ...
  test "index includes live category summary" do
    travel_to Time.zone.local(2026, 5, 15, 12, 0, 0) do
      ...
      assert_includes response.body, "expenditure-focus-collapse"
      assert_includes response.body, 'data-expenditure-focus-collapse-target="collapsible"'
      assert_operator response.body.scan(/data-expenditure-focus-collapse-target="input"/).size, :==, 2
